...
export const weapons = [
    {
    name: 'Dagger, Cudgel, Sickle, 5 Staff, etc.',
    defense: 0,
    damage: 'd6',
    hands: '1 hand',
    slot: 1,
    ...
    {
    name: 'Spear, Sword, Mace, Axe, 10 Flail, etc.',
    defense: 0,
    damage: 'd8',
    hands: '1 hand',
    slot: 2,
    ...
    {
    name: 'Halberd, War Hammer, 20 Long Sword, Battle Axe, etc.',
    defense: 0,
    damage: 'd10',
    hands: '2 hand',
    slot: 3,
